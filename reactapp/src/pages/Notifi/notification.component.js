...
import NotificationDropdown from '~/pages/Notifi/NotificationDropdown.component';
            ...
            <div className="flex justify-center">
                <div className="block w-full mx-6">
                    <div className="mt-[52px] mb-7">
                        <div className="mb-10">
                            <h1 className="text-5xl font-bold font-customs">Notifications</h1>
                        </div>
                    ...
                    <div className="mt-12">
                        <div className="mx-6">
                            {/* All */ }
                            { activeTab === '1' && <>
                                <NotificationDropdown type="all" />
                            </> }

                            {/* Responese */ }
                            { activeTab === '2' && <>
                                <NotificationDropdown type="comment" />
                            </> }
                        </div>
                    </div>
                </div>
