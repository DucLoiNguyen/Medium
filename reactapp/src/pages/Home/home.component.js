        ...
        <>
            <div className="sticky top-0 pt-4 mt-10 bg-white border-b-2">
                <div className="flex mx-6 place-items-center">
                    ...
                    <div>
                        <a className="text-[#6b6b6b] hover:text-black" href="/#" onClick={() => handleTabClick('1')}>
                            <div className={`pb-4 mr-8 ${activeTab === "1" ? "border-b-2 border-black" : "hover:border-b-2 hover:border-black"}`}>
                                <p className="text-sm">For you</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a className="text-[#6b6b6b] hover:text-black" href="/#" onClick={() => handleTabClick('2')}>
                            <div className={`pb-4 mr-8 ${activeTab === "2" ? "border-b-2 border-black" : "hover:border-b-2 hover:border-black"}`}>
