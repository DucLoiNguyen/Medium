                ...
                <div className="flex mx-6 place-items-center">
                    ...
                    <div>
                        <button className="text-[#6b6b6b] hover:text-black"  onClick={() => handleTabClick('1')}>
                            <div className={`pb-4 mr-8 ${activeTab === "1" ? "border-b-2 border-black text-black" : "hover:border-b-2 hover:border-black"}`}>
                    ...
                    <div>
                        <button className="text-[#6b6b6b] hover:text-black"  onClick={() => handleTabClick('2')}>
                            <div className={`pb-4 mr-8 ${activeTab === "2" ? "border-b-2 border-black text-black" : "hover:border-b-2 hover:border-black"}`}>
