                ...
                <div className="relative flex justify-end w-full place-items-center">
                    <div className="hidden pr-6 md:block">
                        <a href="/#" className="text-sm text-black">
                            <div className="mx-2">Our story</div>
                        </a>
                    </div>
                    <div className="hidden pr-6 md:block">
                        <a href="/#" className="text-sm text-black">
                            <div className="mx-2">Membership</div>
                        </a>
                    </div>
                    <div className="hidden pr-6 md:block">
                        <a href="/#" className="text-sm text-black">
                    ...
                    <div className="">
                        <a href="/#" className="flex text-white bg-black rounded-full hover:opacity-75">
                            <div className="px-4 py-2 mx-2">Get start</div>
                        </a>
                    </div>
                </div>
            </nav>
