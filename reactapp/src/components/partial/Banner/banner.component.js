function Banner() {
  return (
    <>
      {/* <div className="flex bg-[#ffc017] w-full">
                <div className="container flex mx-auto divide-x justify-ceneter">
                    <div className="h-[585]">
                        <h2>hello</h2>
                    </div>
                </div>
                <div className="right-0 block w-fit ">
                    <div>
...
"
        ...
        <div className="container mx-auto z-2">
          <div className="flex mx-6">
            <div className="w-[550px] py-24">
              <div className=" flex mb-[35px]">
                <h2 className="text-6xl xl:text-8xl">Stay Curious</h2>
              </div>
              ...
              <div>
                <a
                  href="/#"
                  className="flex text-white bg-black rounded-full hover:opacity-75 w-[213px]"
                >
                  <div className="flex justify-center w-full px-5 py-2 mx-2 text-xl">
                    Start reading
                  </div>
                </a>
              </div>
