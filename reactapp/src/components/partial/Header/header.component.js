        ...
        <>
            <nav className="flex justify-end w-full px-6 shadow h-14">
                <div className="flex place-items-center">
                    ...
                    <div className="relative flex items-center mx-4 group bg-neutral-50 rounded-l-3xl rounded-r-3xl">
                                ...
                                <div className="px-2 py-4">
                                    <Menu.Item className="flex">
                                        {({ active }) => (
                                            ...
                                            <div className="flex ml-4 place-itmes-center">
                                                <p className="text-sm text-center max-h-5 place-itmes-center">Profile</p>
                                            </div>
                                            </a>
                                        )}
                                    </Menu.Item>
