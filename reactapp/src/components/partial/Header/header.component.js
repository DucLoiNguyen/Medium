                ...
                <div className="relative flex justify-end w-full place-items-center">
                    ...
                    <div className="pr-8">
                        <a
                            ...
                            className="text-[#6b6b6b] hover:text-black flex"
                        >
                            <svg
                                width="24"
                                height="24"
                            ...
                            <span
                                className={ `relative flex h-3 w-3 ${ notifications.some(item => item.isRead === false) ? '' : 'hidden' }` }>
                              <span
                                  className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-800 opacity-75"></span>
                              <span className="relative inline-flex rounded-full h-3 w-3 bg-[#419d3f]"></span>
                            </span>
                        </a>
                    </div>
                                ...
                                <div className="px-6 py-4">
                                    ...
                                    <Menu.Item>
                                        { ({ active }) => (
                                            ...
                                            >
                                                <div className="flex">
                                                    <p className="text-sm max-h-5">Your plan</p>
                                                </div>
                                            </a>
                                        ) }
                                    </Menu.Item>
