            ...
            <div className={classNames}>
                <div className="mt-10">
                    ...
                    <div className="">
                        ...
                        <p className="text-xs"><a className="text-[#419d3f] hover:text-black" href="/#">See the full list</a></p>
                    </div>
                </div>
                <div className="mt-10">
                    <div className="pb-4"><h2 className="text-base font-bold">Recommended topics</h2></div>
                    <div className="relative flex flex-wrap">
                        <div className="rounded-full bg-[#f2f2f2] w-fit px-4 py-2 mb-3 mr-2"><a className="text-sm" href="/#">Programming</a></div>
                        <div className="rounded-full bg-[#f2f2f2] w-fit px-4 py-2 mb-3 mr-2"><a className="text-sm" href="/#">Data Science</a></div>
                        <div className="rounded-full bg-[#f2f2f2] w-fit px-4 py-2 mb-3 mr-2"><a className="text-sm" href="/#">Technology</a></div>
                        <div className="rounded-full bg-[#f2f2f2] w-fit px-4 py-2 mb-3 mr-2"><a className="text-sm" href="/#">Writing</a></div>
