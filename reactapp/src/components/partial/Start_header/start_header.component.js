function StartHeader() {
    return (
        <>
            <nav className="sticky top-0 z-40 flex justify-end w-full h-20 px-12 border-b border-black bg-[#f7f4ed]">
                ...
                <div className="relative flex justify-end w-full place-items-center text-xs">
                    ...
                    <div className="">
                        <a
                            href="/register"
                            className="flex text-white bg-black rounded-full hover:opacity-75"
                        >
                            <div className="px-4 py-2 mx-2">Get started</div>
                        </a>
                    </div>
                </div>
            </nav>
