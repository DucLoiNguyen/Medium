          ...
          {data.map((item) => (
            <div className="mt-10">
              ...
              <div className="flex mt-6 mb-10">
                <button className="px-4 py-2 bg-[#1a8917] rounded-full text-white text-sm hover:opacity-75">Follow</button>
                <div className="ml-2">
                  <button className="px-1 py-1 bg-[#1a8917] rounded-full text-white text-sm hover:opacity-75">
